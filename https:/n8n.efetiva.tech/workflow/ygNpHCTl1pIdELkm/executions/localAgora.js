// [INÍCIO DO CÓDIGO COMPLETO E ATUALIZADO - v3.6 (Final Completo)]
...
        regioes: ['jardim oceanico', 'peninsula', 'abm', 'parque das rosas', 'km 1', 'barrinha', 'praça do ó', 'centro empresarial barra shopping', 'barra central park', 'mandala', 'bosque da barra', 'novo leblon', 'americas park', 'mundo novo', 'pedra de itauna', 'blue das americas', 'rio mar', 'associacao bosque marapendi', 'ilha da gigoia', 'rio centro', 'riocentro'],
        condominios: ['malibu', 'mansoes', 'santa monica jardins', 'riserva uno', 'riserva golf', 'golden green', 'le parc', 'interlagos de itauna', 'alphaville', 'waterways', 'atlantico sul', 'london green', 'laguna di mare', 'barramares', 'alfa barra', 'ocean drive', 'crystal lake', 'san diego', 'alphagreen', 'oceana golf', 'san filippo', 'itauna gold', 'praia da barra', 'barra village house life', 'peninsula mondrian', 'mondrian', 'rhr', 'barra bella', 'mandarim', 'mandarim da peninsula', 'on the park peninsula', 'peninsula way', 'be peninsula', 'key west', 'saint george', 'aloha', 'alphaland', 'wonderful ocean suites', 'queen elizabeth', 'alfa barra quality', 'beton', 'palm springs', 'queen mary', 'wyndham', 'blue houses', 'costa del sol', 'saint germain', 'mediterraneo', 'marlin', 'soho residences', 'union square home', 'riviera dei fiori', 'bella vita', 'royal blue', 'ilha de cozumel', 'santa marina', 'palais de nice', 'barra premium', 'jardim europa', 'nova ipanema', 'four seasons', 'liberty place', 'villa borghese', 'barra marina', 'lagoa mar do norte', 'barra summer dream', 'quintas do rio', 'parc des princes', 'casa blanca', 'lake', 'sirius', 'taurus', 'village oceanique', 'saint martin', 'aquarela', 'costa blanca', 'lanai', '360 on the park', 'santa monica condominium club', 'santa mônica residência', 'residencial barra beach', 'pontões da barra', 'laguna', 'nau da barra', 'le monde', 'o2', 'saint tropeiz', 'essencia', 'barra central park', 'rosa do sol', 'barra sunday', 'pier', 'novo leblon', 'mandala', 'barra square', 'alfa plaza', 'alfa classic', 'alfa ritz', 'atol', 'alfa privilege', 'queen anne', 'barrabella', 'sunplaza', 'mudrá', 'saint tropez', 'rosa da barra', 'sunrise', 'allegro', 'barra alegro', 'barrabella inn', 'barra blue', 'barra bonita', 'barra dreams', 'barra family', 'barra first class', 'barra fun', 'barra golden', 'barra golden green', 'barra inn', 'barra light', 'barra mais', 'barra one', 'barra palace', 'barra premier', 'barra quality', 'barra royal plaza', 'barra sol', 'barra sul', 'barra village', 'barra village prime', 'barra zen', 'claris casa & clube', 'gaea home resort', 'atto design by pininfarina', 'epic golf residence', 'wave by yoo', 'pininfarina praia barra', 'itapoã-jatiúca', 'jardim saint tropez', 'lake buena vista', 'marbella', 'residencial paradiso', 'spazio', 'via cancun', 'villa di genova', 'jardim marapendi', 'portal do bosque', 'portal do parque', 'woods park', 'panorama jardim oceânico', 'acquabella', 'alfa park', 'next', 'queen christina', 'queen victoria', 'summer palace', 'long beach', 'rosa da praia', 'rosa maior', 'aldeia do mar', 'coupé tower', 'edificio quadra das praias', 'espacio laguna', 'giuseppe verdi', 'icon golf residence', 'la playa exclusive residences', 'la reserve', 'latitud condominium design', 'les residences saint tropez', 'mudra full living', 'nova barra', 'playa barra da tijuca', 'scena laguna', 'terrazzas', 'ventanas', 'vistta laguna', 'vitality', 'vogue square hotel', 'wanderfull'],
...
        condominios: ['verano', 'verano stay', 'green park', 'maayan', 'reserva do parque', 'bora bora resort', 'like residencial', 'barra mais', 'fontano residencial', 'freedom', 'estrelas full', 'portal do atlantico', 'duet', 'villa aqua', 'origami', 'viure', 'front lake', 'reserva jardim', 'grand prix', 'villa luna', 'villa mare', 'alsacia', 'normandie', 'genova', 'majestic', 'saint michel', 'milênio','seasons', 'soleil', 'villa del mar', 'sicilia', 'ilha pura', 'grand quartier', 'villas da barra', 'residencial aroazes', 'vila pan-americana', 'cidade arte', 'sky barra', 'apogeu', 'stillo', 'marine', 'jardim da barra', 'oro ilha pura', 'apogeu barra', 'arte design', 'arte wave', 'barra único', 'duet barra', 'marine barra residence'],
        apelidos: ['regiao olimpica']
    },
    'Vargem Grande': {
        ruas: ['estrada dos bandeirantes', 'estrada do sacarrao', 'estrada do morgado', 'estrada do morgadinho', 'morgadinho', 'rua manhuacu', 'rua lagoa bonita', 'rua pacui', 'caminho de dentro', 'estrada do rio morto', 'matusalem', 'salomao', 'moinho', 'girassol', 'papoulas', 'cravos', 'azaleias', 'avenida vereador alceu de carvalho', 'rua cleanto paiva leite', 'rua violetas'],
        regioes: ['polo gastronomico', 'parque estadual da pedra branca', 'haras pégasus', 'quilombo cafundá astrogilda', 'sítio das pedras'],
        condominios: ['dom jose', 'jardim de monet', 'novolar vargem grande', 'vitale eco', 'natura clube', 'fazenda vargem grande', 'solar do pontal','de york', 'condado de york', 'saint michel', 'verde vale', 'jardim itauna', 'ville verte', 'village green residence club', 'quality 2', 'jequitibas', 'maramar residencial'],
...
        condominios: ['dom olival', 'village dos oitis', 'reserva da praia', 'giverny', 'village do ouro', 'outside authentic residences', 'rota do sol', 'residencial bandeirantes', 'arte studios', 'vargem alegre', 'casa design', 'grand family', 'advanced', 'el camino real', 'dream garden', 'dream garden ii', 'tangarás recreio', 'vivendas em sossego', 'horizon pedra branca', 'origem ciclo condominio', 'pro lotes', 'avanco vargem pequena', 'origem vargem pequena', 'praia park sol', 'reserva da praia 2'],
        apelidos: ['vargem pequena', 'vargem']
    },
    'Camorim': { ruas: ['estrada do camorim', 'luis carlos da cunha feio', 'abraao jabour', 'ipadu', 'paulo de medeiros', 'olof palme', 'carlos oswald', 'alberto de oliveira', 'reverencia', 'itaperuna', 'itajobi', 'rua pedro calmon'], regioes: ['projac'], condominios: ['reserva natura garden', 'garden vent', 'minha praia', 'frames vila da midia', 'wind', 'way bandeirantes', 'aquagreen', 'floris', 'vent residencial', 'rio stay'], apelidos: [] },
...
    'Jacarepaguá': { bairros: ['jacarepagua', 'tanque'], ruas:['estrada do gabinal'], regioes:['vila do pan', 'espigao'], condominios:['indianoapolis', 'studio 6677', 'village vip', 'up barra', 'vercelli', 'village sol e mar', 'essence', 'neo bandeirantes'], apelidos:[] },
...
    'Leme': { bairros:['leme'], ruas: ['gustavo sampaio', 'roberto dias lopes', 'atlantica'], regioes: ['praia do leme'], condominios: ['sayonara'], apelidos: [] },
