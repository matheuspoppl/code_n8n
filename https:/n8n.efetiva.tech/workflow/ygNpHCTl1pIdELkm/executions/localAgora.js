// [INÍCIO DO CÓDIGO COMPLETO E ATUALIZADO - v2.4 com Base de Conhecimento Massivamente Expandida]
...
// --- BASE DE CONHECIMENTO DE LOCALIZAÇÕES (EXPANDIDA CONFORME SOLICITADO) ---
const knowledgeBase = {
    // Cidades/Regiões fora do RJ (MARCADAS COM type PARA BÔNUS)
    'Niterói': { type: 'cidade', bairros: ['niteroi', 'icarai', 'piratininga', 'engenho do mato', 'camboinhas', 'maravista', 'jardim icarai'], ruas: ['rua oceanica', 'gaviao peixoto'] },
...
    'Mangaratiba': { type: 'cidade', bairros:['mangaratiba'] },
    ...
    'Petrópolis': { type: 'cidade', bairros: ['petropolis', 'centro historico'] },
...
        condominios: ['sublime', 'barra bali', 'maramar', 'art life', 'riviera del sol', 'bothanica nature', 'maui', 'luau do recreio', 'le quartier', 'varandas do mar', 'residencial life', 'sunset', 'barra wave', 'jardins de maria', 'barra sul', 'maximo recreio', 'barra zen', 'sea coast', 'wonderfull', 'nova barra', 'wide', 'maximo recreio resort', 'life resort', 'park premium', 'sublime max', 'green place', 'home ways', 'viverde residencial', 'frames', 'barra allegro', 'bothanica park', 'villa blanca ll', 'barra village lakes', 'mares de goa', 'jardins do recreio', 'ocean breeze', 'camino del sol', 'pátio do sol', 'novolar recreio', 'grumari', 'noir', 'thai club', 'noir design', 'onda carioca', 'parc des palmiers', 'villagio del mare', 'dream village', 'liv lifestyle', 'ocean', 'uprise', 'noir plus', 'jardins de barra bonita', 'medical center', 'luar do pontal', 'summer club', 'top duplex'],
        apelidos: ['recreio']
    },
     'Barra Olímpica': {
        ruas: ['embaixador abelardo bueno', 'abelardo bueno', 'salvador allende', 'jaime poggi', 'coronel pedro correa', 'aroazes', 'franz weissman', 'alfredo ceschiatti', 'mario agostinelli', 'jorge faraj', 'queiros junior', 'francisco de paula', 'abadiana', 'olof palme', 'ipero', 'vilhena de moraes', 'rua sergio camargo'],
        regioes: ['cidade jardim', 'rio 2', 'centro metropolitano', 'villas da barra', 'ilha pura'],
        condominios: ['verano', 'verano stay', 'green park', 'maayan', 'reserva do parque', 'bora bora resort', 'like residencial', 'barra mais', 'seasons', 'fontano residencial', 'freedom', 'estrelas full', 'portal do atlantico', 'duet', 'villa aqua', 'origami', 'viure', 'front lake', 'reserva jardim', 'grand prix', 'villa luna', 'villa mare', 'alsacia', 'normandie', 'genova', 'majestic', 'saint michel', 'milênio', 'soleil', 'villa del mar', 'sicilia'],
...
        condominios: ['dom jose', 'jardim de monet', 'novolar vargem grande', 'vitale eco', 'natura clube', 'fazenda vargem grande', 'solar do pontal', 'saint michel', 'verde vale', 'ville verte', 'jardim itauna'],
...
        condominios: ['dom olival', 'village dos oitis', 'reserva da praia', 'giverny', 'village do ouro', 'outside authentic residences', 'village vip', 'rota do sol', 'residencial bandeirantes', 'arte studios', 'vargem alegre', 'casa design', 'grand family', 'advanced', 'el camino real', 'dream garden', 'dream garden ii', 'tangarás recreio'],
        apelidos: ['vargem pequena', 'vargem']
    },
    'Camorim': {
        ruas: ['estrada do camorim', 'luis carlos da cunha feio', 'abraao jabour', 'ipadu', 'paulo de medeiros', 'olof palme', 'carlos oswald', 'alberto de oliveira', 'reverencia', 'itaperuna', 'itajobi', 'rua pedro calmon'],
        regioes: ['rio centro', 'projac'],
        condominios: ['reserva natura garden', 'garden vent', 'minha praia', 'frames vila da midia', 'wind', 'way bandeirantes', 'aquagreen', 'floris', 'vent residencial', 'rio stay'],
        apelidos: []
    },
...
        condominios:['connect life work trade', 'mio residencial', 'terra nossa', 'ecoway']
    },
...
        regioes: ['largo da freguesia', 'jardim urussanga', 'bairro araujo', 'condominio suiça carioca'],
        condominios: ['grand valley', 'gabinal', 'freedom', 'village florenca', 'residencial matisse', 'trend boutique', 'libero', 'high', 'green hill', 'be happy', 'raro'],
        apelidos: ['freguesia']
    },
...
        condominios:['indianoapolis', 'studio 6677', 'up barra', 'vercelli', 'village sol e mar', 'essence', 'neo bandeirantes'], 
        apelidos:[]
    },
    'Itanhangá': {
        bairros: ['itanhanga'],
...
    'Leblon': {
        ruas: ['carlos gois', 'afranio de melo franco', 'ataulfo de paiva', 'humberto de campos', 'joao lira', 'almirante guilhem', 'sambaiba', 'dias ferreira', 'general urquiza', 'jose linhares', 'rainha guilhermina', 'professor antonio maria teixeira', 'timoteo da costa', 'bartolomeu mitre', 'venancio flores', 'general artigas', 'desembargador alfredo russel', 'delfim moreira', 'aristides espinola', 'visconde de albuquerque', 'fadel fadel', 'tubira', 'mario ribeiro', 'aperana', 'general san martin', 'cupertino durao'],
        regioes: ['quadra da praia', 'baixo leblon', 'alto leblon', '2a quadra', '1a quadra da praia', 'quadrilatero', 'jardim pernambuco'],
        condominios: ['atores', 'san martin', 'meia lua', 'the trend'],
        apelidos: []
    },
    'Ipanema': {
...
        regioes: ['quadra da praia', 'posto 9', 'posto 10', 'copanema', '1a quadra da praia', 'praca general osorio', 'quadrilatero do charme', 'quadrilatero', 'arpoador', '2 quadra da praia'],
        condominios: ['tiffanys residence', 'bossa 107', 'wave ipanema', 'country ipanema', 'diamante azul', 'marias', 'cap ferrat', 'juan les pins'],
        apelidos: []
    },
    'Copacabana': {
        ruas: ['atlantica', 'nossa senhora de copacabana', 'hilario de gouveia', 'bolivar', 'constante ramos', 'santa clara', 'barata ribeiro', 'siqueira campos', 'figueiredo de magalhaes', 'raimundo correia', 'domingos ferreira', 'tonelero', 'bulhoes de carvalho', 'cinco de julho', 'assis brasil', 'belfort roxo', 'paula freitas', 'xavier da silveira', 'ministro viveiro de castro', 'silva castro', 'joseph bloch', 'felipe de oliveira', 'djalma ulrich', 'anita garibaldi', 'miguel lemos', 'pompeu loureiro', 'piragibe frota aguiar', 'republica do peru', 'decio vilares'],
        regioes: ['posto 6', 'posto 5', 'posto 4', 'posto 3', 'posto 2', 'praca eugenio jardim', 'quadra da praia', '1a quadra da praia', 'bairro peixoto', 'arco verde'],
        condominios: ['chopin', 'solimar', 'belair'],
        apelidos: ['copa']
    },
    'Botafogo': {
        ruas: ['real grandeza', 'marques de olinda', 'alvaro ramos', 'lauro muller', 'dezenove de fevereiro', 'fernandes guimaraes', 'rua sao clemente', 'rua voluntários da patria', 'rua general polidoro', 'praia de botafogo', 'rua da matriz', 'sorocaba', 'sao joao batista', 'mena barreto', 'alvares borgerth', 'das palmeiras', 'muniz barreto', 'eduardo guinle'],
        regioes: [],
        condominios: [],
        apelidos: []
    },
    'Flamengo': { 
        bairros:['flamengo'], 
        ruas: ['arthur bernardes', 'buarque de macedo', 'marques de abrantes', 'avenida rui barbosa', 'machado de assis', 'rua paissandu', 'senador vergueiro', 'dois de dezembro', 'fernando osorio'], 
        regioes: [], 
...
    'Leme': { bairros:['leme'], ruas: ['gustavo sampaio', 'roberto dias lopes'], regioes: [], condominios: ['sayonara'], apelidos: [] },
...
    'Tijuca': {
        ruas: ['conde de bonfim', 'jose higino', 'afonso pena', 'amaral', 'uruguai', 'barao de mesquita', 'haddock lobo', 'desembargador izidro', 'general roca', 'sao francisco xavier', 'santo afonso', 'maria', 'rua pereira nunes', 'rua do matoso', 'rua champagnat', 'rua angelo agostini'],
