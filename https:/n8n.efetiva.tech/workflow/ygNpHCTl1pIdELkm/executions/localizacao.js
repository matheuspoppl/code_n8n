...
if (!$json.mensagem_conteudo && !$json.grupo_nome) {
  return { bairro: null, regiao: null, rua: null, condominio: null };
}

// Combina o nome do grupo e o conteúdo da mensagem para ter mais contexto.
const content = ($json.grupo_nome || '') + '\n' + ($json.mensagem_conteudo || '');
...
return result.bairro ? result : { bairro: null, regiao: null, rua: null, condominio: null };